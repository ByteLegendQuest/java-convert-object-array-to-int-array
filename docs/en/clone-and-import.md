...
`git clone https://github.com/ByteLegendQuest/java-convert-object-array-to-int-array`

A project directory named `java-convert-object-array-to-int-array` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-convert-object-array-to-int-array` directory which is created just now.
